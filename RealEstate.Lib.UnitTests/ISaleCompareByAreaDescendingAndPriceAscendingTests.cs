...
namespace RealEstate.Lib.UnitTests
{
    ...
    public class ISaleCompareByAreaDescendingAndPriceAscendingTests
    {
        ...
        public void Compare_CompareTwoISale_ReturnValuesByAreaDescendingAndPriceAscending()
        {
            ...
            { 
               new House(new DateTime(2025, 10, 1), 1500, 25, 4000, "Beautiful House", true, HouseType.Detached),
               new House(new DateTime(2024, 10, 1), 1000, 20, 3000, "crazy House", true, HouseType.Row)
            };
            string expected = sales[0].GetInfo(false);
            //Act
